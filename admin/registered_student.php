...
<td><?php echo $row->firstName."&nbsp";?><?php echo $row->middleName."&nbsp";?><?php echo $row->lastName."&nbsp";?></td>
...
<a href="registered_student.php?del=<?php echo $row->id;?>" title="Delete Record" onclick="return confirm("Do you want to delete");"><i class="fa fa-close"></i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
