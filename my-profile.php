...
$query="update  userregistration set regNo=?,firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,percent=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssifsi',$regno,$fname,$mname,$lname,$gender,$contactno,$percent,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="percent" id="percent"  class="form-control" value="<?php echo $row->percent;?>" required="required">
</div>
</div>
